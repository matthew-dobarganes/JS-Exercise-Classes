...
class Car {
  ...
  drive(distance) {
    const fuelCost = distance / this.milesPerGallon;
  ...
  */
class Lambdasian {
	constructor(lambdasianObj) {
		(this.name = lambdasianObj.name),
			(this.age = lambdasianObj.age),
			(this.location = lambdasianObj.location);
	}
	speak() {
